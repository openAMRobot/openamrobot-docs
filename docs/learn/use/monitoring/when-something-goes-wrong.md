...
**For:** an operator, at the moment something is not right.
...
!!! danger "The dashboard E-STOP is not a safety device"
    ...
    **Use the physical emergency stop.** It is a mechanical device that cuts power. That is why it
    exists and why it must be within reach whenever the robot is powered.
