---
title: Named Poses Config
---

<section class="oamr-hero oamr-hero--compact"><div><span class="oamr-status oamr-status--planned">Under development</span><h1>Named Poses Config</h1><p>Document supported settings, defaults, effects and verification for named poses config.</p></div><img src="https://avatars.githubusercontent.com/u/175850144?v=4" alt="OpenAMRobot logo"></section>
