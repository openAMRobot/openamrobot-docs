...
1. read the organization [Contribution Guide](https://github.com/openAMRobot/.github/blob/main/CONTRIBUTING.md);
2. choose the repository that owns the change using the [repository ecosystem](../reference/repositories.md);
3. sign every commit under the [DCO](https://github.com/openAMRobot/.github/blob/main/DCO.md);
