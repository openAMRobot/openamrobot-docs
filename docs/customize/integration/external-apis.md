...
<section class="oamr-hero oamr-hero--compact"><div><span class="oamr-status oamr-status--planned">Under development</span><h1>External Apis</h1><p>Show how to extend external apis without breaking platform contracts.</p></div><img src="https://avatars.githubusercontent.com/u/175850144?v=4" alt="OpenAMRobot logo"></section>
...
- [openamrobot-comm](https://github.com/openAMRobot/openamrobot-comm) – canonical source, versions, implementation and issue history.
