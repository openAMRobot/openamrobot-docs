...
<section class="oamr-hero oamr-hero--compact"><div><span class="oamr-status oamr-status--planned">Under development</span><h1>Embodied AI</h1><p>Explain embodied ai in plain language and show how it affects OpenAMRobot.</p></div><img src="https://avatars.githubusercontent.com/u/175850144?v=4" alt="OpenAMRobot logo"></section>
...
- [openamrobot-manipulation](https://github.com/openAMRobot/openamrobot-manipulation) — canonical source, versions, implementation and issue history.
